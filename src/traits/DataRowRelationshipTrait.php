...
trait DataRowRelationshipTrait{
	...
	*/
	...
	protected function fillRelationshipAttributes(){
		...
		$this->setDisplayName();
		$this->fillWithConfig('Voyager.'.$this->getModelName().'.'.$this->getRelationshipModelName());
	...
	*/
	...
	protected function setDisplayName(){
		$related_model_name	= preg_replace('/(?<!^)([A-Z])/', ' $1', $this->getRelationshipModelName() );
	...
	*/
	...
	/* getRelationshipModelName
	 */
	protected function getRelationshipModelName(){
		return basename($this->getRelationshipModelNamespace());
	}
	/* getRelationshipModelName
	 */
	protected function getRelationshipModelNamespace(){
